...
function () {
  ...
  (0, _createClass2["default"])(JiraApi, [{
    ...
    key: "setWorklogProperty",
    value: function setWorklogProperty(issueId, worklogId, propertyKey, object) {
      return this.doRequest(this.makeRequestHeader(this.makeUri({
        pathname: "/issue/".concat(issueId, "/worklog/").concat(worklogId, "/properties/").concat(propertyKey)
      }), {
        method: 'PUT',
        body: object
      }));
    ...
    key: "deleteWorklogProperty",
    value: function deleteWorklogProperty(issueId, worklogId, propertyKey) {
      return this.doRequest(this.makeRequestHeader(this.makeUri({
        pathname: "/issue/".concat(issueId, "/worklog/").concat(worklogId, "/properties/").concat(propertyKey)
      }), {
        method: 'DELETE'
